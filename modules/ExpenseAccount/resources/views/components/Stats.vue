...
<template>
  <div class="bg-w dark:bg-surface-950 px-6 py-8 md:px-12 lg:px-20">
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
      <div class="bg-white dark:bg-surface-900 shadow-sm p-5 rounded-2xl">
        <div class="flex justify-between gap-4">
          ...
          <div
              class="flex items-center justify-center bg-gradient-to-b from-cyan-400 dark:from-cyan-300 to-cyan-600 dark:to-cyan-500 rounded-lg w-10 h-10">
      ...
      <div class="bg-white dark:bg-surface-900 shadow-sm p-5 rounded-2xl">
        <div class="flex justify-between gap-4">
          ...
          <div
              class="flex items-center justify-center bg-gradient-to-b from-orange-400 dark:from-orange-300 to-orange-600 dark:to-orange-500 rounded-lg w-10 h-10">
      ...
      <div class="bg-white dark:bg-surface-900 shadow-sm p-5 rounded-2xl">
        <div class="flex justify-between gap-4">
          ...
          <div
              class="flex items-center justify-center bg-gradient-to-b from-slate-400 dark:from-slate-300 to-slate-600 dark:to-slate-500 rounded-lg w-10 h-10">
      ...
      <div class="bg-white dark:bg-surface-900 shadow-sm p-5 rounded-2xl">
        <div class="flex justify-between gap-4">
          ...
          <div
              class="flex items-center justify-center bg-gradient-to-b from-violet-400 dark:from-violet-300 to-violet-600 dark:to-violet-500 rounded-lg w-10 h-10">
